...
def simulacion_con_3d():
    ...
    p_soft = 0.05  # 15% de obstáculos (celdas vacías)
    p_free = 0.85  # 85% de celdas libres (transitables)
    K_monstruos = 2  # Frecuencia de movimiento de monstruos (cada K iteraciones)
    max_iteraciones = K_monstruos * 15  # Permitir más movimientos para mejor gameplay
